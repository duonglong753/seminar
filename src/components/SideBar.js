...
const SideBar = () => {
    return (
        <div>
            <div className="overflow-y-auto py-4 px-3 bg-gray-400 rounded dark:bg-gray-800 h-screen w-64 fixed">
                <ul className="space-y-2">
                    ...
                    <li>
                        <Link to="/product"  className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                            ...
                            <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Products</span>
